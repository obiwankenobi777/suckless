...
static const char col_cyan[]        = "#1f242a";    //dark gray
//static const char col_cyan[]        = "#0088cc";  //blue arch
//static const char col_cyan[]        = "#005577";  //dwm
...
static const Key keys[] = {
    ...
    { MODKEY,                       XK_F6,     spawn,          {.v = xgamma_on} },
    { MODKEY,                       XK_F5,     spawn,          {.v = xgamma_off} },
